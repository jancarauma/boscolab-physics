...
const translations: Record<Locale, Translations> = {
  pt: {
    ...
    particle: { defaultName: 'Particula{id}', positionX: 'Posição X', positionY: 'Posição Y', velX: 'Vel. X', velY: 'Vel. Y', radius: 'Raio (u)', showVelocity: 'Mostrar vetor', trail: 'Rastro', label: 'Rótulo', namePlaceholder: 'ex: bola', position: 'Posição', visualOffset: 'Offset visual', velocityVector: 'Vetor', projections: 'Projeções', scale: 'Escala', vectorColor: 'Cor do vetor', projectionColor: 'Cor da projeção', vectorLabel: 'Rótulo do vetor', projectionXLabel: 'Rótulo proj. X', projectionYLabel: 'Rótulo proj. Y', magnitudeLabel: 'Rótulo do módulo', interpolationHint: 'Use {varname}, {varname:2}, {vx}, {vy}, {mag} ou {mod}', vectorLength: 'Comprimento', image: 'Imagem', useImage: 'Usar imagem', imageFormat: 'PNG/JPG', loadImage: 'Carregar', imageLoaded: '✓ Imagem carregada — salva no projeto .modx' },
    pendulum: { defaultName: 'Pêndulo{id}', angle: 'Ângulo θ', length: 'Comprimento L', pivotX: 'Pivot X', pivotY: 'Pivot Y', bobRadius: 'Raio bob (u)', bobColor: 'Cor bob', rodColor: 'Cor haste', rotation: 'Rotação °' },
    ...
    circle: { defaultName: 'Círculo{id}', centerX: 'Centro X', centerY: 'Centro Y', radiusUnit: 'Raio (u)', radiusPixel: 'Raio (u)', borderColor: 'Cor borda', fillColor: 'Cor fill' },
    rectangle: { defaultName: 'Rect{id}', width: 'Largura', height: 'Altura' },
    textLabel: { defaultName: 'Texto{id}', posX: 'Pos X', posY: 'Pos Y', text: 'Texto', textPlaceholder: 't = {t:2}s', size: 'Tamanho (u)', interpolationHint: 'Use {varname} ou {varname:2} para interpolar valores' },
  ...
  en: {
    ...
    particle: { defaultName: 'Particle{id}', positionX: 'Position X', positionY: 'Position Y', velX: 'Vel. X', velY: 'Vel. Y', radius: 'Radius (u)', showVelocity: 'Show vector', trail: 'Trail', label: 'Label', namePlaceholder: 'e.g. ball', position: 'Position', visualOffset: 'Visual offset', velocityVector: 'Vector', projections: 'Projections', scale: 'Scale', vectorColor: 'Vector color', projectionColor: 'Projection color', vectorLabel: 'Vector label', projectionXLabel: 'X projection label', projectionYLabel: 'Y projection label', magnitudeLabel: 'Magnitude label', interpolationHint: 'Use {varname}, {varname:2}, {vx}, {vy}, {mag}, or {mod}', vectorLength: 'Length', image: 'Image', useImage: 'Use image', imageFormat: 'PNG/JPG', loadImage: 'Load', imageLoaded: '✓ Image loaded — saved in .modx project' },
    pendulum: { defaultName: 'Pendulum{id}', angle: 'Angle θ', length: 'Length L', pivotX: 'Pivot X', pivotY: 'Pivot Y', bobRadius: 'Bob radius (u)', bobColor: 'Bob color', rodColor: 'Rod color', rotation: 'Rotation °' },
    ...
    circle: { defaultName: 'Circle{id}', centerX: 'Center X', centerY: 'Center Y', radiusUnit: 'Radius (u)', radiusPixel: 'Radius (u)', borderColor: 'Border color', fillColor: 'Fill color' },
    rectangle: { defaultName: 'Rect{id}', width: 'Width', height: 'Height' },
    textLabel: { defaultName: 'Text{id}', posX: 'Pos X', posY: 'Pos Y', text: 'Text', textPlaceholder: 't = {t:2}s', size: 'Size (u)', interpolationHint: 'Use {varname} or {varname:2} to interpolate values' },
