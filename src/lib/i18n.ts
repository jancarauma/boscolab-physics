...
const translations: Record<Locale, Translations> = {
  pt: {
    ...
    particle: { positionX: 'Posição X', positionY: 'Posição Y', velX: 'Vel. X', velY: 'Vel. Y', radius: 'Raio (px)', showVelocity: 'Mostrar vetor', trail: 'Rastro', label: 'Rótulo', namePlaceholder: 'ex: bola', position: 'Posição', visualOffset: 'Offset visual', velocityVector: 'Vetor', projections: 'Projeções', scale: 'Escala', vectorColor: 'Cor do vetor', projectionColor: 'Cor da projeção', vectorLabel: 'Rótulo do vetor', projectionXLabel: 'Rótulo proj. X', projectionYLabel: 'Rótulo proj. Y', magnitudeLabel: 'Rótulo do módulo', interpolationHint: 'Use {varname}, {varname:2}, {vx}, {vy}, {mag} ou {mod}', vectorLength: 'Comprimento', image: 'Imagem', useImage: 'Usar imagem', imageFormat: 'PNG/JPG', loadImage: 'Carregar', imageLoaded: '✓ Imagem carregada — salva no projeto .modx' },
  ...
  en: {
    ...
    particle: { positionX: 'Position X', positionY: 'Position Y', velX: 'Vel. X', velY: 'Vel. Y', radius: 'Radius (px)', showVelocity: 'Show vector', trail: 'Trail', label: 'Label', namePlaceholder: 'e.g. ball', position: 'Position', visualOffset: 'Visual offset', velocityVector: 'Vector', projections: 'Projections', scale: 'Scale', vectorColor: 'Vector color', projectionColor: 'Projection color', vectorLabel: 'Vector label', projectionXLabel: 'X projection label', projectionYLabel: 'Y projection label', magnitudeLabel: 'Magnitude label', interpolationHint: 'Use {varname}, {varname:2}, {vx}, {vy}, {mag}, or {mod}', vectorLength: 'Length', image: 'Image', useImage: 'Use image', imageFormat: 'PNG/JPG', loadImage: 'Load', imageLoaded: '✓ Image loaded — saved in .modx project' },
