  ...
  projetil: {
    ...
    objects: [
      ...
      { type: 'vector', x: '0', y: '0', vx: 'x1', vy: 'y1', color: '#22c55e', 
        ...
        magLabel: 'Distância até a Origem = {mag:1} m/s', projXLabel: 'xA = {x1:1}', projYLabel: 'yA = {y1:1}' },        
