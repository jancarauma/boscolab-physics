  ...
  projetil: {
    ...
    objects: [
      ...
      { type: 'particle', x: 'x1', y: 'y1', color: '#fc0808', trailColor: '#b60000', 
        ...
        magLabel: 'Velocidade de A = {v1:1} m/s', radius: 1, useImage: true, 
...
percent_charge = 100*(vc/Vs)`,
  ...
  cargas: {
    ...
    objects: [
      { type: 'vectorfield', fxExpr: '(x+2)/((x+2)^2+y^2+0.02)^1.5 - (x-2)/((x-2)^2+y^2+0.02)^1.5', 
        fyExpr: 'y/((x+2)^2+y^2+0.02)^1.5 - y/((x-2)^2+y^2+0.02)^1.5', 
